...
export interface FormItemProps {
  ...
  feedbackLayout?: 'loose' | 'terse' | 'popover' | 'none' | (string & object)
  feedbackStatus?: 'error' | 'warning' | 'success' | 'pending' | (string & object)
...
function useOverflow(containerRef: Ref<HTMLElement>) {
...
const ICON_MAP = {
  info: () => h(NIcon, {}, { default: () => h(InfoFilled, {}, {}) }),
  error: () => h(NIcon, {}, { default: () => h(CircleClose, {}, {}) }),
  success: () => h(NIcon, {}, { default: () => h(CircleCheck, {}, {}) }),
  warning: () => h(NIcon, {}, { default: () => h(Warning, {}, {}) }),
}
...
export const FormBaseItem = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      const gridColumn = props.gridSpan as string // 'span 1'
